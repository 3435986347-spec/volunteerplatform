...
const ENDPOINTS = {
  volunteer: {
    ...
    activity: {
      ...
      checkOut: (id) => `/v/activity/activities/${id}/check-out`,
      ...
      managedCheckInQr: (id) => `/v/activity/managed-activities/${id}/check-in-qr`,
      managedCheckOutQr: (id) => `/v/activity/managed-activities/${id}/check-out-qr`,
